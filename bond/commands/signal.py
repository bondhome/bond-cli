...
class SignalCommand(BaseCommand):
    ...
    arguments = [
        ...
        (["--bps"], {"help": "Signal data rate (bits per second)", "type": int, "default": 40000}),
        ...
        (["--use-scan"], {"help": "Whether or not to use the most recently-scanned buffer (takes precedence over all other arguments!)", "action": "store_true"}),
    ]
